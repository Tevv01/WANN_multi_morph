...
# > Walker-v0 - Random 5x5 morph - Variable actuators (max 10 out-nodes)
# The network will adapt to morphologies with fewer actuators by only using
# the first N outputs where N is the number of actuators in the morphology
